  ...
  <div class="column content-editable">
    <div class="card">
      <header class="card-header">
        <div class="buttons">
          <span class="button is-small tooltip" 
            v-for="(btn, indx) of commands"
            :key="indx"
            :data-tooltip="btn.desc"
            @click="btnAction(btn.cmd, btn.val)">
            <span class="icon">
      ...
      <div id="content-edit" class="card-content content" contenteditable="true"
      @input="updateContent">
